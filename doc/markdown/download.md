...
- __OMPL__ 1.3.2, released Jul 23, 2018 ([release notes](releaseNotes.html))

  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.3.2-Source.tar.gz" class="btn btn-primary btn-sm">TGZ</a>
  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.3.2-Source.zip" class="btn btn-primary btn-sm">ZIP</a><br><br>
...
- [Installation script for Ubuntu 14.04, 15.10, 16.04, and 17.10 that installs the latest OMPL version from source](install-ompl-ubuntu.sh)
